...
cmd(
  ...
  async (oshiya, mek, m, { from, quoted, q, reply, pushname }) => {
    try {
      ...
      if (m?.type === "imageMessage" || isQuotedImage) {
        ...
        const st = new Sticker(roundedPng, {
          pack: pushname || "oshiya-MD",
          author: "oshadha manuppriya",
        ...
        await oshiya.sendMessage(from, { sticker: buf }, { quoted: mek });
      ...
      console.error("❌ oshiya-MD Sticker Error:", e);
